...
cat("Please select the 'Real Wages Trends HK.csv' file\n")
...
write_csv(real_wages, "real_wages_hk.csv")
...
write_csv(final_data, "real_wages_hk_cleaned.csv")
